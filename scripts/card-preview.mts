...
const RECAP: RecapData = {
  ...
  results: [
    { id: 'p-noa', name: 'Noa Friedman', solved: true, score: 96, mistakes: 0, solvedLevels: [2, 1, 0, 3], sec: 102 },
    { id: 'p-theo', name: 'Theo Lindqvist', solved: true, score: 91, mistakes: 0, solvedLevels: [3, 2, 1, 0], sec: 88 },
    { id: 'p-jun', name: 'Jun Park', solved: true, score: 84, mistakes: 1, solvedLevels: [0, 1, 2, 3], sec: 141 },
    { id: 'p-priya', name: 'Priya Nair', solved: true, score: 77, mistakes: 1, solvedLevels: [1, 0, 3, 2], sec: 169 },
    { id: 'p-aria', name: 'Aria Voss', solved: true, score: 68, mistakes: 2, solvedLevels: [3, 1, 2, 0], sec: 203 },
    { id: 'p-yuki', name: 'Yuki Sato', solved: true, score: 61, mistakes: 3, solvedLevels: [0, 2, 1, 3], sec: 247 },
