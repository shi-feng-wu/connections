...
- We have a new name: Disconnections. Same game, same rooms, same scores.
- A fresh look to go with it: richer group colors tuned for dark mode, and cooler-toned tiles.
- /disconnections is the new launch command. /connections and /play still work like before.
